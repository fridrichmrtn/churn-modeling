...
models = {
               ...
               {"classification":
                ...
                "regression":
                   {"mlp__regressor__batch_size":hp.randint("mlp__regressor__batch_size",2**3,2**6),
                    "mlp__regressor__epochs":hp.randint("mlp__regressor__epochs",10**2,10**3),
                    "mlp__regressor__layers":hp.randint("mlp__regressor__layers",1,10),
                    "mlp__regressor__units":hp.randint("mlp__regressor__units",2**2,2**8),
                    "mlp__regressor__activation":hp.choice("mlp__regressor__activation", ["elu", LeakyReLU()]),
                    "mlp__regressor__optimizer__learning_rate":hp.uniform("mlp__regressor__optimizer__learning_rate", 10**-5,10**-3),
    ...
    "rf":{
           ...
           "space":
               ...
               "regression":
                   {"rf__regressor__n_estimators":hp.randint("rf__regressor__n_estimators",25,1000),
   ...
   "gbm":{
          "model":{
              "classification":
                  [("gbm", LGBMClassifier())],
              "regression":
                  [("gbm", TransformedTargetRegressor(regressor=LGBMRegressor(),
                      transformer=PowerTransformer()))]},
          "space":
              {"classification":
                  {"gbm__learning_rate":hp.uniform("gbm__learning_rate",0.005,.15),
               ...
               "regression":
                   {"gbm__regressor__learning_rate":hp.uniform("gbm__regressor__learning_rate",0.005,.15),
                   "gbm__regressor__n_estimators":hp.randint("gbm__regressor__n_estimators",25,1000),
                   ...
                   "gbm__regressor__subsample_freq":hp.randint("gbm__regressor__subsample_freq",1,10),
